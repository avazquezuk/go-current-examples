...
<#
    ...
    .EXAMPLE
        ...
        .\Install-LatestReleaseWithExistingCosta.ps1 -ConnectionString 'Data Source=PTPOPW04JD56\AVMSQLSERVER;Initial Catalog=CostaCoffeeTestLab;Integrated Security=True' -ServiceUser 'alejandrova@lsretail.com' -ServicePassword (ConvertTo-SecureString -String 'DummyPassword' -AsPlainText -Force)
        ```
...
#>
param(
    $ConnectionString = 'Data Source=PTPOPW04JD56\AVMSQLSERVER;Initial Catalog=CostaCoffeeTestLab;Integrated Security=True',
    [Parameter(Mandatory)]
    $ServiceUser,
    [Parameter(Mandatory)]
    [SecureString] $ServicePassword,
    $InstanceName = 'LSC-KDS-CostaCoffee'
)
...
$Arguments = @{
    'bc-server' = @{
        ...
        PublicWebBaseUrl = 'http://localhost:8080/LSC-KDS-CostaCoffee'
