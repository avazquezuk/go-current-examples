...
<#
    ...
    .EXAMPLE
        ...
        .\Install-LatestReleaseWithExistingDjurs21_6.ps1 -ConnectionString 'Data Source=PTPOPF5VSEB7\AVMSQLSERVER;Initial Catalog=djurs_hosp_21_1_60;Integrated Security=True' -ServiceUser 'alejandrova@lsretail.com' -ServicePassword (ConvertTo-SecureString -String 'DummyPassword' -AsPlainText -Force)
        ```
...
#>
param(
    $ConnectionString = 'Data Source=PTPOPF5VSEB7\AVMSQLSERVER;Initial Catalog=djurs_hosp_21_1_60;Integrated Security=True',
    [Parameter(Mandatory)]
