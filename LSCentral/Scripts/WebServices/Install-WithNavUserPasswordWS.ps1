...
$Arguments = @{
    'bc-server'                = @{
        ...
        ConnectionString = 'Data Source=PTPOPW04JD56\AVMSQLSERVER;Initial Catalog=LSC-VoyadoHO;Integrated Security=True'
    }
    'bc-web-client'            = @{
...
$Packages | Install-UscPackage -InstanceName 'LSC-VoyadoHO-WS' -UpdateStrategy 'Manual' -Arguments $Arguments