...
<#
    ...
    .EXAMPLE
        ...
        .\Install-LatestReleaseWithExistingDF_21.4.ps1 -ConnectionString 'Data Source=PTPOPW04JD56\AVMSQLSERVER;Initial Catalog=DF-21_4;Integrated Security=True' -ServiceUser 'alejandrova@lsretail.com' -ServicePassword (ConvertTo-SecureString -String 'DummyPassword' -AsPlainText -Force)
        ```
...
$Arguments = @{
    'bc-server' = @{
        ...
        PublicWebBaseUrl = 'http://localhost:8080/DF-21-4'
