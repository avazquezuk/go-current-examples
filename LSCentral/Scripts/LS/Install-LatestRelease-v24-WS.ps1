...
$Arguments = @{
    'bc-server'                = @{
        ...
        ConnectionString = 'Data Source=PTPOPW04JD56\AVMSQLSERVER;Initial Catalog=LSC-Release-v24;Integrated Security=True'
    }
    'bc-web-client'            = @{
...
$Packages | Install-UscPackage -InstanceName 'LSC-Release-v24-WS' -UpdateStrategy 'Automatic' -Arguments $Arguments